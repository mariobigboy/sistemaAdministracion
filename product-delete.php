...
<?php
	...
	foreach ($result as $row) {
		...
		if(!($p_featured_photo=='product-default.jpg' || $p_featured_photo=='product-default.png' || $p_featured_photo=='product-default.gif' || $p_featured_photo=='product-default.jpeg')){
	...
	$statement = $pdo->prepare("DELETE FROM tbl_stock WHERE sk_id_producto=?");
	$statement->execute(array($_REQUEST['id']));
