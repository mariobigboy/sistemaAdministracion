...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['tcat_name'])) {
        $valid = 0;
        $error_message .= "El nombre de la Sección no puede estar vacío<br>";
    } else {
    	...
    	{
    		$valid = 0;
        	$error_message .= "El nombre de la Sección ya existe<br>";
    	}
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'Sección Agregada correctamente!.';
    }
}
?>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Nombre de la Sección <span>*</span></label>
							<div class="col-sm-4">
								<input type="text" class="form-control" name="tcat_name">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Mostrar en Menú? <span>*</span></label>
							<div class="col-sm-4">
