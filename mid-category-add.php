...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['tcat_id'])) {
        $valid = 0;
        $error_message .= "Debes seleccionar una Sección primero<br>";
    }

    if(empty($_POST['mcat_name'])) {
        $valid = 0;
        $error_message .= "El Rubro no puede estar vacío<br>";
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'El Rubro ha sido agregado correctamente!.';
    }
}
?>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Nombre del Rubro <span>*</span></label>
							<div class="col-sm-4">
...
<script type="text/javascript">
	/*$(document).ready(function(){
		$('button[name="form1"]').click(function(){
