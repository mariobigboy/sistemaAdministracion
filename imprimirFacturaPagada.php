<?php 
	...
	if($id!=0){
		...
		//obtenemos factura:
		$statement = $pdo->prepare("SELECT t1.*, t2.*, t3.p_name, t3.p_code, t4.*, FROM_UNIXTIME(t2.fecha, '%d/%m/%Y %H:%i') fecha_format FROM `detalle` AS t1 INNER JOIN factura AS t2 ON t2.num_factura = t1.id_factura INNER JOIN tbl_product AS t3 ON t1.id_producto = t3.p_id INNER JOIN tbl_cliente as t4 ON t2.id_cliente = t4.c_id WHERE t2.num_factura = ?;");
		...
		$(document).ready(function(){
			...
			var dd = {
				...
				content: [
					...
					{
						text: '<?php echo "Factura N°: ".$num_factura; ?>',
						//style: 'subheader',
    				            ...
    				            <?php 
    				            	...
    				            	switch ($arrayPagos['metodo1']) {
    				            		case '1':
    				            			...
    				            			break;
    				            		case '2':
    				            			$linea = '[{text: "'.$i.'"}, {text: "Tarjeta de Crédito"}, {text: "$'.$arrayPagos['subt1'].'"}, ],';
    				            			$i+=1;
    				            			break;
    				            		case '3':
    				            			...
    				            			break;
    				            		case '4':
    				            			$linea = '[{text: "'.$i.'"}, {text: "Cuenta Corriente +++++ PAGADO +++++"}, {text: "$'.$arrayPagos['subt1'].'"}, ],';
    				            			$i+=1;
    				            			break;
    				            		default:
    				            			$linea = '';
    				            	...
    				            	switch ($arrayPagos['metodo2']) {
    				            		case '1':
    				            			...
    				            			break;
    				            		case '2':
    				            			$linea = '[{text: "'.$i.'"}, {text: "Tarjeta de Crédito"}, {text: "$'.$arrayPagos['subt2'].'"}, ],';
    				            			$i+=1;
    				            			break;
    				            		case '3':
    				            			...
    				            			break;
    				            		case '4':
    				            			$linea = '[{text: "'.$i.'"}, {text: "Cuenta Corriente +++++ PAGADO +++++"}, {text: "$'.$arrayPagos['subt2'].'"}, ],';
    				            			$i+=1;
    				            			break;
    				            		default:
    				            			$linea = '';
    				            	...
    				            	switch ($arrayPagos['metodo3']) {
    				            		case '1':
    				            			...
    				            			break;
    				            		case '2':
    				            			$linea = '[{text: "'.$i.'"}, {text: "Tarjeta de Crédito"}, {text: "$'.$arrayPagos['subt3'].'"}, ],';
    				            			$i+=1;
    				            			break;
    				            		case '3':
    				            			...
    				            			break;
    				            		case '4':
    				            			$linea = '[{text: "'.$i.'"}, {text: "Cuenta Corriente +++++ PAGADO +++++"}, {text: "$'.$arrayPagos['subt3'].'"}, ],';
    				            			$i+=1;
    				            			break;
    				            		default:
    				            			$linea = '';
