...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
		...
		$statement->execute(array(
										...
										strip_tags($_POST['c_tipo_doc']),
										strip_tags($_POST['c_nro_doc']),
										strip_tags($_POST['c_genero']),
										strip_tags($_POST['c_email']),
										strip_tags($_POST['c_tel']),
										strip_tags($_POST['c_cel']),
										strip_tags($_POST['c_razon_social']),
										strip_tags($_POST['c_apodo']),
										strip_tags($_POST['c_id_cond_iva']),
										strip_tags($_POST['c_cuit']),
										strip_tags($_POST['c_id_provincia']),
										strip_tags($_POST['c_id_localidad']),
										strip_tags($_POST['c_cp']),
										strip_tags($_POST['c_calle']),
										strip_tags($_POST['c_calle_nro']),
										strip_tags($_POST['c_barrio']),
										strip_tags($_POST['c_activo'])
									));
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select name="c_id_localidad" class="form-control selLocalidades" disabled>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" name="c_cp" class="form-control" placeholder="4400">
							</div>
						</div>
