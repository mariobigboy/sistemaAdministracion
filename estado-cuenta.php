				...
				<div class="box-body table-responsive">
					...
					<table id="tablaClientes" class="table table-bordered table-striped">
						...
						<tbody>
							...
							$statement = $pdo->prepare("SELECT * FROM cuenta_corriente as cc INNER JOIN tbl_cliente as c ON cc.id_cliente = c.c_id GROUP BY c.c_id ORDER BY cc.fecha DESC;"); //WHERE cc.tipo = 0
							$statement->execute();
							...
							foreach ($result as $row) {
								...
								<tr>
									...
									<td>
										<?php if($row['tipo'] == 0) {echo 'Adeuda';} else {echo 'Cancelado';} ?>
									</td>
									<td>
									...
									<td>										
										<a href="clientes-cuenta.php?id=<?php echo $row['c_id']; ?>" class="btn btn-primary btn-xs">Ver</a>
