		...
		<div class="col-md-12">
			<div class="box box-info">
				<div class="box-body table-responsive">
					<table id="tablaCustomers" class="table table-bordered table-striped">
						<thead>
							<tr>
								<th width="30">N°</th>
								<th width="180">Nombre</th>
								<th width="180">Email</th>
								<th width="180">País, Ciudad, Provincia</th>
								<th>Estado</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>¿Está seguro de eliminar este Cliente Online?</p>
            </div>
