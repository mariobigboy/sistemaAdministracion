<?php
	...
	$arrOut = array();
	if($q != ""){
		$sql="SELECT d.id_detalle, d.nombre, d.cantidad, d.precio FROM `detalle` AS d
		INNER JOIN factura as f ON f.num_factura = d.id_factura WHERE d.id_producto = '-1' AND d.id_factura = '$q' AND d.precio > 0;";
