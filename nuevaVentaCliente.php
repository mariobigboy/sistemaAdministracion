	...
	function calcularTodo(){
		...
		if ($('#metodo').val()!="" || $('#metodo1').val()!="" || $('#metodo2').val()!="") {
			...
			$('#btnAgregar1').on('click',function(){
				...
				//test:
				$('#aCobrar1').val((parseFloat($('#totalVenta').val()) - parseFloat($('#aCobrar').val())).toFixed(2));
			...
			$('#btnAgregar2').on('click',function(){
				...
				//test:
				$('#aCobrar2').val((parseFloat($('#totalVenta').val()) - parseFloat($('#aCobrar1').val()) - parseFloat($('#aCobrar').val())).toFixed(2));
			});
