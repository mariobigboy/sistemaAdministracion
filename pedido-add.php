				...
				<div class="box box-info">
					...
					<div id="pedidosGral">
						...
						<?php } ?>
							...
							<div class="form-group">
								<label for="" class="col-sm-3 control-label"><i class="fa fa-photo"></i> Foto 3</label>
								<div class="col-sm-4">
									<input type="file" name="foto3" class="form-control">
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label"><i class="fa fa-photo"></i> Foto 4</label>
								<div class="col-sm-4">
									<input type="file" name="foto4" class="form-control">
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label"><i class="fa fa-photo"></i> Foto 5</label>
								<div class="col-sm-4">
									<input type="file" name="foto5" class="form-control">
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label"><i class="fa fa-photo"></i> Foto 6</label>
								<div class="col-sm-4">
									<input type="file" name="foto6" class="form-control">
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label"><i class="fa fa-photo"></i> Foto 7</label>
								<div class="col-sm-4">
									<input type="file" name="foto7" class="form-control">
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label"><i class="fa fa-photo"></i> Foto 8</label>
								<div class="col-sm-4">
									<input type="file" name="foto8" class="form-control">
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label"><i class="fa fa-photo"></i> Foto 9</label>
								<div class="col-sm-4">
									<input type="file" name="foto9" class="form-control">
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label"><i class="fa fa-photo"></i> Foto 10</label>
								<div class="col-sm-4">
				...
				success: function (data) {
					...
					setTimeout(function(){
						...
						if (data==1) {
							...
							setTimeout(function(){window.location.href="pedidos.php"},1000);
						}else{
