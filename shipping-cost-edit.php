...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['country_id'])) {
        $valid = 0;
        $error_message .= "Debe elegir un país<br>";
    } else {
    ...
    if($valid == 1) {    	
    	...
    	$success_message = '¡Costo de Envío actualizado correctamente!';
    }
}
?>
            ...
            <div class="box box-info">
                <div class="box-body">
                    <div class="form-group">
                        <label for="" class="col-sm-2 control-label">Seleccione un País <span>*</span></label>
                        <div class="col-sm-4">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ¿Está seguro de eliminar este Monto?
            </div>
