...
if(isset($_POST['form1'])) {
	...
	if(empty($_POST['post_content'])) {
		$valid = 0;
		$error_message .= 'El Posteo no puede estar vacío<br>';
	}
	...
	if($valid == 1) {
	    ...
	    $success_message = 'Posteo actualizado!';
	}
}
?>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Título del Posteo <span>*</span></label>
							<div class="col-sm-6">
						...
						<div class="form-group">
				            <label for="" class="col-sm-2 control-label">Foto Destacada Existente</label>
						...
						<div class="form-group">
				            <label for="" class="col-sm-2 control-label">Cambiar Foto</label>
				            <div class="col-sm-6" style="padding-top:6px;">
