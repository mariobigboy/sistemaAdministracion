...
if(isset($_POST['form_about'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Página Nosotros ha sido actualizada correctamente.';
...
if(isset($_POST['form_faq'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Páginas FAQ actualizada correctamente.';
...
if(isset($_POST['form_blog'])) {
    ...
    if(empty($_POST['blog_title'])) {
        $valid = 0;
        $error_message .= 'Título no puede estar vacío<br>';
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Información Blog actualizada correctamente.';
...
if(isset($_POST['form_contact'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Información Página de Contacto actualizada correctamente.';
...
if(isset($_POST['form_pgallery'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Información de la Página de la Galería actualizada correctamente.';
...
if(isset($_POST['form_vgallery'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Información de la Página de Video actualizada correctamente.';
        ...
        <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#tab_1" data-toggle="tab">Nosotros</a></li>
                        ...
                        <li><a href="#tab_5" data-toggle="tab">Galería de Fotos</a></li>
                        <li><a href="#tab_6" data-toggle="tab">Galería de Videos</a></li>
                    </ul>
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Título de Página * </label>
                                        <div class="col-sm-5">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Banner Existente</label>
                                        <div class="col-sm-6" style="padding-top:6px;">
                                            <img src="../assets/uploads/<?php echo $about_banner; ?>" class="existing-photo" style="height:80px;">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Nuevo Banner</label>
                                        <div class="col-sm-6" style="padding-top:6px;">
                                            <input type="file" name="about_banner">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Meta Título</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Meta Descripción </label>
                                        <div class="col-sm-8">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form_blog">Actualizar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form_pgallery">Actualizar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form_vgallery">Actualizar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
