...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['category_name'])) {
        $valid = 0;
        $error_message .= "El nombre de Categoría no puede estar vacía<br>";
    } else {
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="category.php" class="btn btn-primary btn-sm">Ver todos</a>
	</div>
</section>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Confirmación Eliminación</h4>
            </div>
