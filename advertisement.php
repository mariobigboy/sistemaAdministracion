...
if(isset($_POST['form1'])) {
    ...
    if($_POST['adv_type'] == 'Image Advertisement') {
        ...
        if(empty($_POST['adv_adsense_code'])) {
            $valid = 0;
            $error_message .= 'Debe introducir un adsense code<br>';
        }
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Publicidad actualizada.';
    }
}
        ...
        <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#tab_1" data-toggle="tab">Arriba de la sección de Bienvenida</a></li>
                        <li><a href="#tab_2" data-toggle="tab">Arriba Producto destacado</a></li>
                        <li><a href="#tab_3" data-toggle="tab">Arriba Últimos Productos</a></li>
                        <li><a href="#tab_4" data-toggle="tab">Arriba Productos más vistos</a></li>
                        <li><a href="#tab_5" data-toggle="tab">Arriba Comentarios</a></li>
                        <li><a href="#tab_6" data-toggle="tab">Sección Categorías</a></li>
                    </ul>
                                ...
                                <div class="box box-info">
                                    <div class="box-body">
                                            ...
                                            <div class="col-sm-6" style="width:auto;">
                                                <select name="adv_type" class="form-control" onchange="funcTab1(this)">
                                                    ...
                                                    if($adv_type[0] == 'Image Advertisement') {
                                                        ?>
                                                            <option value="Image Advertisement" selected>Imagen</option>
                                        ...
                                        <div class="form-group" id="tabField2">
                                            <label class="col-sm-3 control-label">Nueva Foto<br><span style="font-size:12px;font-weight:normal;">(Ancho recomendado: 1170 pixels Alto: cualquiera)</span></label>
                                            <div class="col-sm-5" style="padding-top:5px;">
                                            ...
                                            <div class="col-sm-6" style="width:auto;">
                                                <select name="adv_type" class="form-control"onchange="funcTab2(this)">
                                                    ...
                                                    if($adv_type[1] == 'Image Advertisement') {
                                                        ...
                                                        ?>
                                                            <option value="Image Advertisement">Imagen</option>
                                                            <option value="Adsense Code" selected>Adsense Code</option>
                                                        <?php
                                                    }
                                                    ?>
                                ...
                                <div class="box box-info">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group" id="tabField22">
                                            <label class="col-sm-3 control-label">Nueva Foto<br><span style="font-size:12px;font-weight:normal;">(Recommended Width: 260 pixels and Height: any size)</span></label>
                                            <div class="col-sm-5" style="padding-top:5px;">
                                                <input type="file" name="photo">
                                            </div>
                                        </div>
