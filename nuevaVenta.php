...
<section class="content-header">
	...
	<br>
	<?php if ($id==-1) {?>
		<a href="nuevaVentaCliente.php?id=21" class="btn btn-info">Venta rapida</a> 
	<?php } ?>
</section>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							...
							<div class="btn-group" role="group" >
								...
								<a  class="btn btn-info" id="btnPromo">Promo / Nota Crédito</a>
...
<?php }else{ header("location: nuevaVentaCliente.php?id=".$id); ?>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title" id="myLabelModal" style="color: #000;"><i class="fa fa-number"></i> Descripción de la Promo / Nota Crédito</h4>
			</div>
			<div class="modal-body">
		...
		<script type="text/javascript">
			...
			$('#btnAgregar1').on('click',function(){
				...
				//test:
				$('#aCobrar1').val(parseFloat($('#totalVenta').val()) - parseFloat($('#aCobrar').val()));
			});
			...
			$('#btnAgregar2').on('click',function(){
				...
				//test:
				$('#aCobrar2').val(parseFloat($('#totalVenta').val()) - parseFloat($('#aCobrar1').val()) - parseFloat($('#aCobrar').val()));
			});
			...
			$('#btnQuitar3').on('click',function(){
				...
				$('#metodo2').val("");
				//$('#aCobrar2').val("");
				$('#interesVenta3, #interesTotal3').val(0);
				$('#intMod3').hide();
				calcularTodo();
