...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['category_name'])) {
        $valid = 0;
        $error_message .= "El nombre de la Categoría no puede estar vacío<br>";
    } else {
    	...
    	{
    		$valid = 0;
        	$error_message .= "La Categoría ya existe.<br>";
    	}
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'Categoría ha sido agregada.';
    }
}
?>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Nombre Categoría <span>*</span></label>
							<div class="col-sm-4">
								<input type="text" class="form-control" name="category_name" placeholder="Ejemplo: Deco Tips">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Ficha Categoría </label>
							<div class="col-sm-4">
								<input type="text" class="form-control" name="category_slug" placeholder="Ejemplo: deco-tips">
							</div>
						</div>
						<h3 class="seo-info">SEO (SOLO PROGRAMADOR)</h3>
						<div class="form-group">
