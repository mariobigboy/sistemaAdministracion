...
if(isset($_POST['form1'])) {
	...
	if($_SESSION['user']['role'] == 'Super Admin') {
	    ...
	    if(empty($_POST['email'])) {
	        $valid = 0;
	        $error_message .= 'La dirección de Email no puede estar vacía.<br>';
	    } else {
	    	if (filter_var($_POST['email'], FILTER_VALIDATE_EMAIL) === false) {
		        $valid = 0;
		        $error_message .= 'El email debe ser válido.<br>';
		    } else {
		    	...
		    	if($total) {
		    		$valid = 0;
		        	$error_message .= 'La dirección de Email ya existe.<br>';
		    	}
		    }
	    }
...
if(isset($_POST['form2'])) {
    ...
    if($path!='') {
        ...
        if( $ext!='jpg' && $ext!='png' && $ext!='jpeg' && $ext!='gif' ) {
            $valid = 0;
            $error_message .= 'Debe subir foto en formato jpg, jpeg, gif o png.<br>';
        }
    }
    ...
    if($valid == 1) {
        ...
        $success_message = '¡Foto de Usuario actualizada correctamente!';
          				...
          				<div class="tab-pane active" id="tab_1">
							...
							<div class="box box-info">
								<div class="box-body">
									...
									<div class="form-group">
										<label for="" class="col-sm-2 control-label">Dirección de Email <span>*</span></label>
										<?php
										if($_SESSION['user']['role'] == 'Super Admin') {
											?>
												<div class="col-sm-4">
          				...
          				<div class="tab-pane" id="tab_3">
							...
							<div class="box box-info">
								<div class="box-body">
									...
									<div class="form-group">
										<label for="" class="col-sm-2 control-label">Re-escribir Contraseña </label>
										<div class="col-sm-4">
