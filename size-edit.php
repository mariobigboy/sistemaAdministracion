...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['size_name'])) {
        $valid = 0;
        $error_message .= "El nombre del Talle no puede estar vacío.<br>";
    } else {
    	...
    	if($total) {
    		$valid = 0;
        	$error_message .= 'El nombre del Talle ya existe.<br>';
    	}
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = '¡El talle fue actualizado correctamente!';
    }
}
?>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Nombre del Talle <span>*</span></label>
                    <div class="col-sm-4">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ¿Está seguro de eliminar este Talle?
            </div>
