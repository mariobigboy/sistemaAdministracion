...
if(isset($_POST['form2'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Favicon actualizado correctamente.';
...
if(isset($_POST['form3'])) {
    ...
    $success_message = 'La configuración general se actualizó correctamente.';
...
if(isset($_POST['form4'])) {
    ...
    $success_message = 'Configuraciones del formulario de Contacto actualizada correctamente.';
}
...
if(isset($_POST['form5'])) {
    ...
    $success_message = 'Configuraciones de la barra lateral configurada correctamente.';
}
...
if(isset($_POST['form6_0'])) {
    ...
    $success_message = 'Configuración de sección On-Off configurada correctamente.';
}
...
if(isset($_POST['form6'])) {
    ...
    $success_message = 'Home metaetiquetas actualizadas correctamente.';
}
...
if(isset($_POST['form6_7'])) {
    ...
    if(empty($_POST['cta_read_more_text'])) {
        $valid = 0;
        $error_message .= 'El texto "Leer más" no puede estar vacío.<br>';
    }

    if(empty($_POST['cta_read_more_url'])) {
        $valid = 0;
        $error_message .= 'la URL de "Leer más no puede estar vacío."<br>';
    }
    ...
    if($path != '') {
        ...
        if( $ext!='jpg' && $ext!='png' && $ext!='jpeg' && $ext!='gif' ) {
            $valid = 0;
            $error_message .= 'Debe subir archivos jpg, jpeg, gif o png.<br>';
        }
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Los datos han sido actualizados correctamente.';
...
if(isset($_POST['form6_4'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Los datos del Producto destacado no puede estar vacío..';
...
if(isset($_POST['form6_5'])) {
    ...
    if(empty($_POST['latest_product_title'])) {
        $valid = 0;
        $error_message .= 'El título de último Productos no puede estar vacío.<br>';
    }

    if(empty($_POST['latest_product_subtitle'])) {
        $valid = 0;
        $error_message .= 'El subtítulo de último Productos no puede estar vacío<br>';
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Último Producto actualizado correctamente.';
...
if(isset($_POST['form6_6'])) {
    ...
    if(empty($_POST['popular_product_title'])) {
        $valid = 0;
        $error_message .= 'El título de Productos más vistos.<br>';
    }

    if(empty($_POST['popular_product_subtitle'])) {
        $valid = 0;
        $error_message .= 'El subtítulo de Productos más vistos.<br>';
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Datos de Productos más vistos actualizados correctamente.';
...
if(isset($_POST['form6_1'])) {
    ...
    if(empty($_POST['testimonial_title'])) {
        $valid = 0;
        $error_message .= 'El título de Comentarios no puede estar vacío.<br>';
    }

    if(empty($_POST['testimonial_subtitle'])) {
        $valid = 0;
        $error_message .= 'El subtítulo de Comentarios no puede estar vacío.<br>';
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Datos de comentarios actualizados correctamente.';
...
if(isset($_POST['form6_2'])) {
    ...
    if(empty($_POST['blog_title'])) {
        $valid = 0;
        $error_message .= 'El título del Blog no puede estar vacío.<br>';
    }

    if(empty($_POST['blog_subtitle'])) {
        $valid = 0;
        $error_message .= 'El subtítulo del Blog no puede estar vacío<br>';
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Datos del Blog actualizados correctamente.';
...
if(isset($_POST['form6_3'])) {
        ...
        $success_message = 'Texto de Noticias actualizados correctamente.';
...
if(isset($_POST['form7_1'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'El Banner de la Página de Login ha sido actualizado correctamente.';
...
if(isset($_POST['form7_2'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Banner del Registro de Usuarios actualizado correctamente.';
...
if(isset($_POST['form7_3'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Banner de recuperación de contraseña actualizado.';
...
if(isset($_POST['form7_4'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Banner de Reseteo de contraseña actualizado.';
...
if(isset($_POST['form7_6'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Banner de Página de Búsqueda actualizado.';
...
if(isset($_POST['form7_7'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Banner del carro de compra actualizado.';
...
if(isset($_POST['form7_8'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Banner Pago actualizado correctamente.';
...
if(isset($_POST['form7_9'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Banner Página Categoría de Productos actualizado.';
...
if(isset($_POST['form7_10'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Banner del Blog actualizado.';
...
if(isset($_POST['form9'])) {
    ...
    $success_message = 'Configuraciones de Pago actualizada correctamente.';
}
...
if(isset($_POST['form10'])) {
    ...
    $success_message = 'Scripts de "Head" y "Body" actualizado correctamente.';
}
...
if(isset($_POST['form11'])) {
    ...
    $success_message = 'Sección ON-OFF de publicidades actualizada correctamente.';
}

if(isset($_POST['form12'])){
    //aquí lo del formulario 12 (mercadopago)
    ...
    $statement->execute(array(
                            $_POST['mp_email'],
                            $_POST['mp_public_key'],
                            $_POST['mp_access_token'],
                            $_POST['mp_active'],
                            $_POST['mp_client_id'],
                            $_POST['mp_client_secret']
                        ));
    $success_message = 'Datos de MercadoPago actualizados correctamente.';
}
...
foreach ($result as $row) {
    ...
    $mp_active       = $row['mp_active'];
    $mp_client_id = $row['mp_client_id'];
    $mp_client_secret = $row['mp_client_secret'];
}
?>
        ...
        <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_6" data-toggle="tab">Página Principal</a></li>
                        <li><a href="#tab_7" data-toggle="tab">Banner</a></li>
                        <li><a href="#tab_9" data-toggle="tab">Métodos de Pago</a></li>
                        <li><a href="#tab_10" data-toggle="tab">Head & Body Scripts</a></li>
                        <li><a href="#tab_11" data-toggle="tab">Publicidad</a></li>
                        <li><a href="#tab_12" data-toggle="tab">MercadoPago</a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab_3">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Sección Noticias </label>
                                        <div class="col-sm-3">
                                    ...
                                    <div class="form-group hidden">
                                        <label for="" class="col-sm-2 control-label">Footer - Nosotros </label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Contact Dirección </label>
                                        <div class="col-sm-6">
                                            <textarea class="form-control" name="contact_address" style="height:140px;"><?php #echo $contact_address;
                                            $statm = $pdo->prepare("SELECT s_address FROM tbl_sucursales WHERE s_address<>'Internet' ORDER BY s_address;");
                                            $statm->execute();
                                            $res = $statm->fetchAll(PDO::FETCH_ASSOC);
                                            foreach ($res as $fila) {
                                                echo "- ".$fila['s_address']."\n";
                                            }
                                             ?></textarea>
                        ...
                        <div class="tab-pane" id="tab_5">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Footer (Cuántos posteos Recientes?)<span>*</span></label>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" name="total_recent_post_footer" value="<?php echo $total_recent_post_footer; ?>">
                                        </div>
                                    </div>      
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Footer (Cuántos posteos más relevantes?)<span>*</span></label>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" name="total_popular_post_footer" value="<?php echo $total_popular_post_footer; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Sidebar (Cúantos posteos más recientes?)<span>*</span></label>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" name="total_recent_post_sidebar" value="<?php echo $total_recent_post_sidebar; ?>">
                                        </div>
                                    </div>      
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Sidebar (Cuántos posteos más populares?)<span>*</span></label>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" name="total_popular_post_sidebar" value="<?php echo $total_popular_post_sidebar; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Página Principal(Cuántos Productos Destacados?)<span>*</span></label>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" name="total_featured_product_home" value="<?php echo $total_featured_product_home; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Página Principal (Cuántos últimos Productos?)<span>*</span></label>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" name="total_latest_product_home" value="<?php echo $total_latest_product_home; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Página Principal (Cuántos productos más vistos?)<span>*</span></label>
                                        <div class="col-sm-2">
                        ...
                        <div class="tab-pane" id="tab_6">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Sección Servicios </label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Sección Últimos Productos </label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Sección Productos más vistos </label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Sección Comentarios Clientes </label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Sección Blog </label>
                                        <div class="col-sm-4">
                            ...
                            <h3>Sección Meta (Sólo Programador)</h3>
                            <form class="form-horizontal" action="" method="post">
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                            ...
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form6_7">Actualizar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <h3>Sección Producto Destacado</h3>
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Título Producto Destacado<span>*</span></label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="featured_product_title" value="<?php echo $featured_product_title; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Subtítulo Producto Destacado<span>*</span></label>
                                        <div class="col-sm-8">
                            ...
                            <h3>Sección Últimos Productos</h3>
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Título Últimos Productos<span>*</span></label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="latest_product_title" value="<?php echo $latest_product_title; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Subtítulo Últimos Productos<span>*</span></label>
                                        <div class="col-sm-8">
                            ...
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Subtítulo<span>*</span></label>
                                        <div class="col-sm-8">
                            ...
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Background Exitente</label>
                                        <div class="col-sm-6" style="padding-top:6px;">
                                            <img src="../assets/uploads/<?php echo $testimonial_photo; ?>" class="existing-photo" style="height:80px;">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Neuevo Background</label>
                                        <div class="col-sm-6" style="padding-top:6px;">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form6_1">Actualizar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form6_2">Actualizar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Texto Noticia</label>
                                        <div class="col-sm-8">
                        ...
                        <div class="tab-pane" id="tab_7">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Banner Página Recordar Contraseña Existente</h4>
                                        <p>
                                            <img src="<?php echo '../assets/uploads/'.$banner_forget_password; ?>" alt="" style="width: 100%;height:auto;">   
                                        </p>                                        
                                    </td>
                                    <td style="width:50%">
                                        <h4>Cambiar Banner Página Recordar Contraseña</h4>
                                        Select Photo<input type="file" name="photo">
                                ...
                                <tr>
                                    ...
                                    <td style="width:50%">
                                        <h4>Banner Página Resetear Contraseña</h4>
                                        Select Photo<input type="file" name="photo">
                                ...
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Banner Página Categoría de Producto</h4>
                                        <p>
                                            <img src="<?php echo '../assets/uploads/'.$banner_product_category; ?>" alt="" style="width: 100%;height:auto;">  
                                        </p>                                        
                                    </td>
                                    <td style="width:50%">
                                        <h4>Cambia Banner Página Categoría de Producto</h4>
                                        Select Photo<input type="file" name="photo">
                        ...
                        <div class="tab-pane" id="tab_11">
                            <h3>Publicidad On & Off</h3>
                            <form class="form-horizontal" action="" method="post">
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Arriba de Welcome </label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Arriba de Productos Destacados </label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Arriba de Últimos Productos </label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Arriba de Productos Más Vistos </label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Arriba de Comentarios </label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Barra Lateral Categorías </label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form11">Actualizar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab_12">
                            <form class="form-horizontal" action="" method="post">
                                <div class="box box-info">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label"> <i class="fa fa-at"></i> Email MercadoPago </label>
                                            <div class="col-sm-5">
                                                <input type="text" name="mp_email" class="form-control" value="<?php echo $mp_email; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label"> <i class="fa fa-key"></i> Public Key </label>
                                            <div class="col-sm-5">
                                                <input type="text" name="mp_public_key" class="form-control" value="<?php echo $mp_public_key; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label"><i class="fa fa-key"></i> Access Token </label>
                                            <div class="col-sm-5">
                                                <input type="text" name="mp_access_token" class="form-control" value="<?php echo $mp_access_token; ?>">
                                            </div>
                                        </div>
                                        <!--
                                            $mp_client_id = $row['mp_client_id'];
                                        ...
                                        -->
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label"><i class="fa fa-key"></i> Cliente ID </label>
                                            <div class="col-sm-5">
                                                <input type="text" name="mp_client_id" class="form-control" value="<?php echo $mp_client_id; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label"><i class="fa fa-key"></i> Client Secret </label>
                                            <div class="col-sm-5">
                                                <input type="text" name="mp_client_secret" class="form-control" value="<?php echo $mp_client_secret; ?>">
                                            </div>
                                            <a href="https://www.mercadopago.com/mla/account/credentials" target="_blank">Obtener datos de mi cuenta MercadoPago</a>
                                        </div>
                                        <div class="form-group">
                                            <label for="" class="col-sm-3 control-label"><i class="fa fa-toggle-on"></i> Activo </label>
                                            <div class="col-sm-4">
                                                <select name="mp_active" class="form-control" style="width:auto;">
                                                    <option value="1" <?php if($mp_active == '1') {echo 'selected';} ?>>Sí</option>
                                                    <option value="0" <?php if($mp_active == '0') {echo 'selected';} ?>>No</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label"></label>
                                            <div class="col-sm-6">
                                                <button type="submit" class="btn btn-success pull-left" name="form12">Actualizar</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
