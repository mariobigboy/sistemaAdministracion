...
<section class="content-header">
	<div class="content-header-left">
		<h1>Mensajes de Clientes E-Commerce</h1>
	</div>
</section>
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<button type="submit" class="btn btn-success pull-left" name="form1">Ver</button>
							</div>
						</div>
					</div>
				</div>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Ver Todos los Mensajes del Cliente</h1>
	</div>
</section>
		...
		<div class="col-md-12">
			<div class="box box-info">
				<div class="box-body table-responsive">
					<table id="tablaMensajesCliente" class="table table-bordered table-striped">
						<thead>
							<tr>
								<th width="30">N°</th>
